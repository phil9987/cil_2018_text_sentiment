...
% CUSTOM FONT SIZES FOR CREATING SPECIAL SYMBOLS
\usepackage{relsize}
...
% COMMENTS
\newcommand{\maurice}[1]{\noindent\textcolor{purple}{[Maurice: #1]}}
\newcommand{\reto}[1]{\noindent\textcolor{orange}{[Reto: #1]}}
\newcommand{\philip}[1]{\noindent\textcolor{green}{[Philip: #1]}}
\newcommand{\andreas}[1]{\noindent\textcolor{blue}{[Andreas: #1]}}
