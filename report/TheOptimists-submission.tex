...
\begin{abstract}
  ...
  Our first baseline (random forest) achieved an accuracy of 72\%. 
  Our second (RNN/GRU) achieved accuracy of 85.2\%.
  Our best final model achieved an accuracy of 87.4\% with the initial first half
  of the test set and 86.6\% with the second half of the test set
