...
\begin{abstract}
  ...
  Our second baseline uses a Recurrent Neural Network (RNN) model with an accuracy of TODO: rnn-baseline-accuracy.
  For our final implementation we refined our second baseline, incorporating \todo{describe novel approach}, in a RNN-based approach. 
  Our final model achieves a classification accuracy of 86.6\%.
\end{abstract}
...
lower accuracy. Additonally, we experimented with LSTM cells, which did not result in
